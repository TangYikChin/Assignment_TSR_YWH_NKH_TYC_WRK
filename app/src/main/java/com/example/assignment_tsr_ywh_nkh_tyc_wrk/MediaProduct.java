...
public class MediaProduct extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName = (TextView) findViewById(R.id.mediaName);
        productPrice = (TextView) findViewById(R.id.mediaPrice);
                ...
                reference.child("User View").child("Product").child(productName.getText().toString()).updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(MediaProduct.this, "Added To Cart List!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
