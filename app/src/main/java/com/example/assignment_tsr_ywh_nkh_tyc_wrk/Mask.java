...
public class Mask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName = (TextView) findViewById(R.id.mask2);
        productPrice = (TextView) findViewById(R.id.price_Mask2);
                ...
                reference.child("User View").child("Product").child(productName.getText().toString()).updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(Mask.this, "Added To Cart List!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
